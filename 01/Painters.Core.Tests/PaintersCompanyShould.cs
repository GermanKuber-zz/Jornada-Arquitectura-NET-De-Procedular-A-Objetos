...
namespace Painters.Core.Tests
{
    public class PaintersCompanyShould
    {
        ...
        {
            var cheapest = new ProportionalPainter(PainterStatus.Available, new TimeSpan(0, 0, 30, 0, 0), 11);
        ...
        {
            var faster = new ProportionalPainter(PainterStatus.Available, new TimeSpan(0, 0, 39, 0, 0), 11);
